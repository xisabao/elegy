...
urlpatterns = [
	...
	url(r'^classes/(?P<theclass>[0-9]+)/post/(?P<pk>[0-9]+)/delete/$', views.post_delete, name="post_delete"),
	url(r'^classes/(?P<theclass>[0-9]+)/assignment/(?P<pk>[0-9]+)/delete/$', views.assignment_delete, name="assignment_delete"),
